    ...
    <div className="min-h-screen py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <nav className="mb-6">
          ...
          <Link href={`/problems/${categoryId}`} className="text-blue-600 hover:text-blue-800">
            {categoryName}
          </Link>
        </nav>
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
              <div>
                ...
                <div className="flex flex-wrap items-center gap-4 mt-2">
                  ...
                  <span className={`px-3 py-1 rounded-full text-sm ${difficultyColors[problem.difficulty]}`}>
                    {problem.difficulty}
                  </span>
                    ...
                    <div className="flex">
                      ...
                      <div className="ml-3">
                        <p className="text-sm text-yellow-700">
                          ...
                          <Link href="/login" className="font-medium text-yellow-800 underline ml-1">Log in</Link> to save your progress.
                        </p>
                      </div>
                    </div>
                  </div>
                      ...
                      <div>
                        ...
                        {currentUser ? (
                          ...
                          <p className="text-green-700 mt-2">
                            ...
                            <Link href="/login" className="font-medium text-green-800 underline ml-1">Log in now</Link>
                          </p>
                        )}
                      </div>
                    ) : (
