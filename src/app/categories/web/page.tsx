          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white bg-opacity-10 rounded-lg p-4">
              ...
              <ul className="space-y-1 text-sm">
                <li><a href="https://owasp.org/www-project-top-ten/" target="_blank" rel="noopener noreferrer" className="hover:underline">OWASP Top 10</a></li>
                <li><a href="https://portswigger.net/web-security" target="_blank" rel="noopener noreferrer" className="hover:underline">PortSwigger Academy</a></li>
              </ul>
            </div>
            <div className="bg-white bg-opacity-10 rounded-lg p-4">
              <h3 className="font-semibold mb-2">Practice Platforms</h3>
              <ul className="space-y-1 text-sm">
                <li><a href="https://hackthebox.eu" target="_blank" rel="noopener noreferrer" className="hover:underline">Hack The Box</a></li>
                <li><a href="https://tryhackme.com" target="_blank" rel="noopener noreferrer" className="hover:underline">TryHackMe</a></li>
              </ul>
            </div>
            <div className="bg-white bg-opacity-10 rounded-lg p-4">
              <h3 className="font-semibold mb-2">Tools</h3>
              <ul className="space-y-1 text-sm">
                <li><a href="https://portswigger.net/burp" target="_blank" rel="noopener noreferrer" className="hover:underline">Burp Suite</a></li>
                <li><a href="https://github.com/sqlmapproject/sqlmap" target="_blank" rel="noopener noreferrer" className="hover:underline">SQLMap</a></li>
              </ul>
            </div>
            <div className="bg-white bg-opacity-10 rounded-lg p-4">
