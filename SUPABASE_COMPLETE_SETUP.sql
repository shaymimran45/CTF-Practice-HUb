-- Complete Supabase Setup Script for CTF Practice Hub
...
-- Insert sample categories with gradient colors for modern UI
...
-- Insert sample problems with detailed descriptions and hints
